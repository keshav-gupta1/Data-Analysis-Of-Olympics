...
def data_over_time(df, col):
    ...
    temp_df = temp_df['Year'].value_counts().reset_index()
...
def most_successful(df, sport):
    ...
    available_cols = [col for col in ['Name', 'Sport', 'region', 'Region'] if col in temp_df.columns]
    df_small = temp_df[available_cols].drop_duplicates('Name')

    # Merge safely
    x = x.merge(df_small, on='Name', how='left')
